...
public class UserController {
    ...
    public ResponseEntity<UserListResponse> getAllDriver() {
        ...
        try {
            ...
            UserListResponse res = UserListResponse.builder().drivers(data).message("OK").build();

            return new ResponseEntity<>(res, HttpStatus.OK);

        } catch (Exception e) {
            return new ResponseEntity<>(
                    UserListResponse.builder().message("Something went wrong.").build(),
    ...
    public ResponseEntity<UserResponse> getDriver(@PathVariable String id) {
        ...
        try {
            ...
            if (driver == null) {
                return new ResponseEntity<>(
                        UserResponse.builder().message("Invalid Id").build(), HttpStatus.NOT_FOUND);
            }

            return new ResponseEntity<>(
                    UserResponse.builder().driver(driver).message("OK").build(), HttpStatus.OK);

        } catch (Exception e) {
            return new ResponseEntity<>(
                    UserResponse.builder().message("Something went wrong.").build(),
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<UserResponse> insertDriver(@RequestBody User driver) {
        ...
        try {
            ...
            UserResponse res = UserResponse.builder().driver(insertedDriver).message("OK").build();
